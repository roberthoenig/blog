...
BLOG_AUTHOR = "Robert Hönig"  # (translatable)
BLOG_TITLE = "Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://roberthoenig.github.io/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://roberthoenig.github.io/blog/"
BLOG_EMAIL = "robhoenig@gmail.com"
...
NAVIGATION_LINKS = {
        DEFAULT_LANG: (
            ...
            ('https://roberthoenig.github.io/blog/', 'About me', 'icon-user'),
            ('https://twitter.com/oneroberthoenig', 'My Twitter', 'icon-twitter'),
            ('https://github.com/roberthoenig', 'My Github', 'icon-github'),
        )
}
...
FAVICONS = (
    ...
    ("icon", "/icon_16x16.ico", "16x16"),
    ("icon", "/icon_32x32.ico", "32x32"),
    ("icon", "/icon_256x256.ico", "256x256"),
)
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-116692434-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-116692434-1');
</script>
"""
